...
class BaseDatos {
    ...
    function __construct() {
        $this->_dbConn = pg_connect('host=localhost dbname=c12_personal user=postgres password=pgs161176') or die('No se ha podido conectar: ' . pg_last_error());
    }
    ...
    public function recuperaPeriodo($empleado,$periodo,$anio){
        ...
        //determinar inicio y fin del periodo y empleado al que se debe recuperar informaci�n
        $mod = new Modelo();
