 ...
 * Se debe llamar especificando el empleado, el periodo y el a�o
 *
...
//TRATAMIENTO DIFERENCIADO CUANDO POST ESTA CONFIGURADA.
    if(!$_POST) {
    //si la variable post est� definida, recupero la fecha de inicio y de final del periodo requerido y
    ...
    <body>
        ...
        <form name="periodoAno">
            <fieldset style="padding: 10px;">
                <legend>Periodo y A�o</legend>

                <p>
                    <label for="spinPeriodo">Periodo:</label>
                    <input id="spinPeriodo" name="periodo">
                    <label for="spinAnio" style="margin-left: 50px;" >A�o:</label>
